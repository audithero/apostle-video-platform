...
export const Route = createFileRoute("/_authed/admin/series/new")({
...
function NewSeriesPage() {
  ...
  const createSeries = useMutation(trpc.series.create.mutationOptions());
  ...
  return (
    <div>
      ...
      <p className="mt-2 text-muted-foreground">Create a new video series.</p>
      ...
      <form onSubmit={handleSubmit} className="mt-8 max-w-2xl space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Add and reorder videos in this series.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {/* Selected Videos */}
            {selectedVideoIds.length > 0 && (
              <div className="space-y-2">
                <Label>Selected Videos (drag to reorder)</Label>
